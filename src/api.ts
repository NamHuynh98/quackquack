...
export const checkIn = () => {
    let config = {
        ...
        headers: {
            ...
            'authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjI3MDI0NCwidGltZXN0YW1wIjoxNzE2NzAzNzEzMjAzLCJ0eXBlIjoxLCJpYXQiOjE3MTY3MDM3MTMsImV4cCI6MTcxNzMwODUxM30.xwIWX93W2lr5NaNaZ8oPl0znkjE_f2DzGdM3SAGWQhc',
...
export const difference = (arrays: string[][]) => {
    return arrays.reduce((a: string[], b: string[]) => a.filter(c => !b.includes(c)))
}
